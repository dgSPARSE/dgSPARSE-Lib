...
spmm_cuda(torch::Tensor csrptr, torch::Tensor indices, torch::Tensor edge_val,
  ...
  //   if (has_value)
  //     if(coarsen_factor == 4) {
  //       csrspmm_parreduce_rowbalance_kernel<int,float,float4><<<gridDim,
  //       blockDim>>>(
  //           Mdim, Ndim, csrptr.data_ptr<int>(),
  //           indices.data_ptr<int>(), edge_val.data_ptr<float>(),
  //           in_feat.data_ptr<float>(), out_feat.data_ptr<float>());
  //     } else if (coarsen_factor == 2){
  //       csrspmm_parreduce_rowbalance_kernel<int,float,float2><<<gridDim,
  //       blockDim>>>(
  //           Mdim, Ndim, csrptr.data_ptr<int>(),
  //           indices.data_ptr<int>(), edge_val.data_ptr<float>(),
  //           in_feat.data_ptr<float>(), out_feat.data_ptr<float>());
  //     } else {
  //       csrspmm_parreduce_rowbalance_kernel<int,float,float><<<gridDim,
  //       blockDim>>>(
  //           Mdim, Ndim, csrptr.data_ptr<int>(),
  //           indices.data_ptr<int>(), edge_val.data_ptr<float>(),
  //           in_feat.data_ptr<float>(), out_feat.data_ptr<float>());
