...
def check_time(gc, direction='forward'):
    ...
    print(f'torch_sparse {direction} time is: {torch_sparse_time_list}')
    print(f'dgl {direction} time is: {dgl_time_list}')
    print(f'dgsparse {direction} time is: {dgsparse_time_list}')
